...
from net.ca_ta_promptxrestormer import CATAPromptXRestormer
...
class CATAPromptXRestormerIRModel(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        restored, ratio_loss, task_ratio_loss = self.net(degrad_patch, training = True)

        loss = self.loss_fn(restored,clean_patch)  + ratio_loss + task_ratio_loss
...
def main():
    ...
    exp_name = "CATAPromptXRestormerIR"
    model = CATAPromptXRestormerIRModel()
