...
class PromptXRestormerEff(nn.Module):
    def __init__(self,
        inp_channels=3,
        out_channels=3,
        dim = 48,
        ...
        super(PromptXRestormerEff, self).__init__()
...
if __name__ == "__main__":
    ...
    # Result:
    # Spatial Attention: 0.4278 [G]
    # Spatial FFN: 3.6517 [G]
    # Channel Attention: 1.8453[G]
    # Channel FFN: 3.6517[G]
    # Others(conv + prompt): 1.7626 [G]
    # Total: 11.3390 [G]
